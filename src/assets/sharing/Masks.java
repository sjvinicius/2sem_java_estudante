...
public class Masks {
   ...
   * @param textField
   */
  public Masks(TextField textField) {
   ...
   * @param datePicker
   */
  public Masks(DatePicker datePicker) {
  ...
  /**
   * Passe o tipo da Mascara. Ex: setMask(Masks.TEL_8DIG);
   *
   * @param maskType
   */
        ...
        if (evento.getCharacter().trim().length() == 0) {
          switch (datePicker.getEditor().getText().length()) {
            case 2:
              datePicker
                .getEditor()
                .setText(datePicker.getEditor().getText().substring(0, 1));
              datePicker
                .getEditor()
                .positionCaret(datePicker.getEditor().getText().length());
              break;
            case 5:
              datePicker
                .getEditor()
                .setText(datePicker.getEditor().getText().substring(0, 4));
              datePicker
                .getEditor()
                .positionCaret(datePicker.getEditor().getText().length());
              break;
  ...
  public void addComponente(TextField field, int maskType, boolean showMask) {
    Masks formatter = new Masks(textField);
  ...
  public void addComponente(
    ...
    Masks formatter = new Masks(datePicker);
    formatter.setMask(maskType);
    if (showMask) {
      formatter.showMask();
    }
